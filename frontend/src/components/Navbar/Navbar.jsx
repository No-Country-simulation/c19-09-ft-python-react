...
const Navbar = () => {
  ...
  return (
    <>
      <ul className={`${menuClicked ? 'hidden' : ''} z-50 absolute  text-white top-0 right-0 w-[256px]  p-[24px] h-full text-[18px] sm:flex sm:items-center sm:w-full  sm:justify-between md:px-10 md:py-6 sm:p-0 sm:h-auto sm:relative sm:text-[16px]`}>
